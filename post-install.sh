...
sudo pacman -S  linux-headers vim fastfetch kitty thunar sddm xdg-desktop-portal-hyprland hyprland \
                polkit-gnome firefox wget unzip rofi-wayland swww qt5-wayland qt6-wayland cliphist \
                thunar-volman thunar-archive-plugin unrar gvfs tumbler brightnessctl slurp nwg-look \
                network-manager-applet grim swappy steam starship btop mangohud lib32-mangohud bluez \
                bluez-utils gamemode vala lib32-gamemode libnewt neovim yazi uwsm nvtop vulkan-tools \
                mesa-utils rtorrent gtk-engines neovide ttf-font-awesome otf-font-awesome ttf-fira-sans \
...
yay -S hyprland-qtutils nvidia-open-dkms nvidia-utils lib32-nvidia-utils nvidia-settings \
       waypaper vesktop qimgv jetbrains-toolbox --noconfirm
